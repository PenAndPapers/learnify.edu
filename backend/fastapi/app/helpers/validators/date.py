...
def is_birth_date_valid_to_register(value: date | None) -> bool:
  """Check if the provided date of birth is valid for registration.
  The user must be at least 10 years old and the date of birth cannot be in the future or before January 1, 1900.
  """
