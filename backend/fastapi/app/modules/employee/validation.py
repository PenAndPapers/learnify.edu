...
class CompensationChangeReasonEnum(StrEnum):
  HIRE = "HIRE"
  RAISE = "RAISE"
  PROMOTION = "PROMOTION"
...
class EmployeeDocumentTypeEnum(StrEnum):
  CONTRACT = "CONTRACT"
  RESUME = "RESUME"
  NDA = "NDA"
  ...
  TAX_FORM = "TAX_FORM"
  I9_ELIGIBILITY = "I9_ELIGIBILITY"
  POLICY_ACKNOWLEDGMENT = "POLICY_ACKNOWLEDGMENT"
  OTHER = "OTHER"


class BankAccountTypeEnum(StrEnum):
  SAVINGS = "SAVINGS"
  CHECKING = "CHECKING"


class PerformanceRatingEnum(StrEnum):
